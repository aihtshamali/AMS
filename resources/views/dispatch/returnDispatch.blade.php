                        ...
                        @for($i=0; $i<10 ;$i++)
                            <td class="col-xs-3" >
                                @if($i<(count($dispatchdetails)))
                                    <input list="customer" style=" padding: 0 0 0 5px; height: 30px;width: 200px"  name="customer[<?=$i?>]" class="form-control" value="{{$dispatchdetails[$row][$col]}}">
                                @else
