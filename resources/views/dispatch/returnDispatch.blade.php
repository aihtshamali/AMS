...
@section('content')
    ...
    float: left;
    font-weight: bold ">Return Dispatch</h3>
            ...
            <div style="position: relative;left:-10px;" class="dispatchHeader">
                <table class="table-responsive table">
                    <tr>
                        ...
                        <td><input  class="form-control datepicker" placeholder="dd-mm-yyyy" data-provide="datepicker" name="cdate" id="" value="{{$dispatch->cdate}}"> </td>

                    </tr>
                    <tr>
                        <td>  <label for="to_">To</label> </td>
                        <td>
                            <input type="text" class="form-control" name="to_" id="" value="{{$dispatch->region->name}}/{{$dispatch->region->sub_name}}" readonly>
                        </td>
                        <td>
