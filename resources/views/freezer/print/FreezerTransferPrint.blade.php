    ...
    <table>
                ...
                <table border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="text-align:center;padding-right: 90px;">
                            ...
                            <div style="font-size:16px;">FREEZER TRANSFER NOTE</div>
                        </td>
                    </tr>
                    <tr >
                        <td align="right" colspan="3" style="position: relative;top:30px">
                            <div style="width:80%;float:left;font:15px;"> Ref No.:</div>
                            <div style="width:30%;margin-bottom: 10px;"class="tbl-data">{{$freezers[0]->transfer->ftn_no}}</div>
                        ...
                        <td colspan="4">
                            <table class="header-box round-border" style="margin-top:4px; border: 1px solid #000000;" cellpadding="5" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td class="tbl-data">{{$freezers[0]->transfer->customer->account_name}}</td>
                                    <td class="tbl-head">Customer Code:</td>
                                    <td class="tbl-data">{{$freezers[0]->transfer->customer->account_no}}</td>
                                </tr>

                                <tr>
                                    <td class="tbl-head">Segment:</td>
                                    <td class="tbl-data">{{$freezers[0]->transfer->customer->getregion($freezers[0]->transfer->customer->region_id)->name}}</td>
                                    <td class="tbl-head">Sub segment:</td>
                                    <td class="tbl-data">{{$freezers[0]->transfer->customer->getcity($freezers[0]->transfer->customer->city_id)->name}}</td>
                                </tr>
                                <tr>
                                    <td class="tbl-head">Delivery Address:</td>
                                    <td colspan="3" class="tbl-data">{{$freezers[0]->transfer->from_}}</td>
                                </tr>
                                </tbody>
                            </table>
                        </td>
        ...
        <tr>
            <td class="gap">
                ...
                <div style=" margin-top: 10px;margin-left: 440px;" class="tbl-data"> Purpose of Placement:<span class="tbl-head">{{$freezers[0]->transfer->purpose}}</span></div>
            </td>
        </tr>
        <tr>
            <td>
                <table border="0" width="100%" style="margin-top:4px; border: 1px solid #000000;font-size:12px;" class="freezer_information">
                    ...
                    @foreach($freezers as $freezer)
                        <tr>
                            ...
                            <td class="tdb">{{$freezer->transfer->placement_date}}</td>
                    ...
                    <tr>
                        ...
                        <th colspan="6" style="padding-left:10px;">Total</th>
        ...
        <tr>
            <td>
                ...
                <ol style="font-size:12px;">
                    ...
                    <li>Customer can not sale or transfer this freezer to anyone and would be charged in case of
                        violence.
                    </li>
            ...
            <td>
                <table border="0" width="100%">
                    ...
                    <tr >
                        ...
                        <td class="tbl-data" width="30%">{{$freezers[0]->transfer->getFaculty($freezers[0]->transfer->tso_id)->name}}</td>
                        <td class="tbl-head" width="10%">RSM:</td>
                        <td class="tbl-data" width="30%">{{$freezers[0]->transfer->getFaculty($freezers[0]->transfer->rsm_id)->name}}</td>
                        <td class="tbl-head" width="10%"> NSM:</td>
                        <td class="tbl-data" width="30%">{{$freezers[0]->transfer->getFaculty($freezers[0]->transfer->nsm_id)->name}}</td>
                    </tr>
                    </tbody>
                </table>
