                ...
                <div class="dispatchHeader">
                    <table class="table-responsive table table-sm">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control" style="" name="ftn_no" id="ref" value="{{$freezer[0]->transfer->ftn_no}}"
                                       readonly>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="text" class="form-control" name="reference" id=""
                                       value="{{$freezer[0]->transfer->reference}}" required>
                            </td>
                            <td align="center">
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="delivery_address" value="{{$freezer[0]->transfer->to_}}" data-width="100%" required></td>
                            <td></td><td></td><td></td>
                        </tr>
                        <tr>
